...
- **2026-05-17**: POST-22「ラベンダーと副交感神経の話」生成・GitHub push 完了（アロマ）
- **2026-05-16**: EP-12「Drum & Bassの進化 — 地下の音が賞を獲った日」生成・GitHub push 完了
- **2026-05-16**: POST-21「マスターナンバーの波動」生成・GitHub push 完了（数秘）
- **2026-05-15**: Daily Notes（journal/ + _templates/daily-note.md）+ Daily Brief RemoteTrigger（毎朝7:00 JST）セットアップ完了
- **2026-05-15**: POST-20「メリッサ（レモンバーム）の静寂」生成・GitHub push 完了（ハーブ菜園）
- **2026-05-15**: EP-11「Jungle & UK Hardcore誕生 — 6秒のAmen Breakが変えた世界」生成・GitHub push完了
- **2026-05-14**: POST-19「薔薇は、精油の中で最も高い周波数を持っている。」生成・GitHub push 完了（アロマ）
- **2026-05-14**: EP-10「なぜUKは音楽文化の震源地なのか」生成・GitHub push完了
- **2026-05-14**: wiki/concepts/music/ 作成 — レイブ音楽関連concept 15ファイルを移動・整理
- **2026-05-13**: POST-02「フランキンセンス」生成・GitHub push 完了（アロマピラー初投稿）
- **2026-05-13**: EP-09「Detroit Technoとイギリスの出会い」自動生成・GitHub push 完了

## Active Threads（優先順）
1. **毎朝EP確認** — GitHub pull → script_ja.md をそのまま使える
2. **Daily Brief → iPhone通知** — Telegram Bot or メール経由で検討中
3. **[[Jungle / Drum and Bass]] ページ作成**（11箇所から参照）→ concepts/music/ に保存
